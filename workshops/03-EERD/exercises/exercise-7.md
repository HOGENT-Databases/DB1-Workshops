...
Stalen behoren steeds tot exact één patiënt. Een patiënt wordt in ons systeem gekenmerkt door een uniek patiënt_id. Verder kennen we de naam en het geslacht van de patiënt. De patiënt hoeft geen stalen te hebben afgegeven om ons systeem opgenomen te worden, daarnaast worden sommige patiënten meerdermaals getest.
